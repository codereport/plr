...
(defmacro tiobe    [] (slurp "./public/data/tiobe/2023-10.txt"))
...
(defmacro prev3-tiobe    [] (slurp "./public/data/tiobe/2023-07.txt"))
...
(defmacro prev6-tiobe    [] (slurp "./public/data/tiobe/2023-04.txt"))
