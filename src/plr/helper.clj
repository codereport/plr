...
(defmacro pypl     [] (slurp "./public/data/pypl/2023-12.txt"))
...
(defmacro prev3-pypl     [] (slurp "./public/data/pypl/2023-09.txt"))
...
(defmacro prev6-pypl     [] (slurp "./public/data/pypl/2023-06.txt"))
(defmacro prev6-tiobe    [] (slurp "./public/data/tiobe/2023-06.txt"))
