...
(defmacro tiobe    [] (slurp "./public/data/tiobe/2023-05.txt"))
...
(defmacro prev-pypl     [] (slurp "./public/data/pypl/2023-03.txt"))
(defmacro prev-tiobe    [] (slurp "./public/data/tiobe/2023-02.txt"))
