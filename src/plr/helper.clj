...
(defmacro tiobe    [] (slurp "./public/data/tiobe/2023-07.txt"))
...
(defmacro prev3-pypl     [] (slurp "./public/data/pypl/2023-04.txt"))
(defmacro prev3-tiobe    [] (slurp "./public/data/tiobe/2023-04.txt"))
...
(defmacro prev6-pypl     [] (slurp "./public/data/pypl/2023-01.txt"))
(defmacro prev6-tiobe    [] (slurp "./public/data/tiobe/2023-01.txt"))
