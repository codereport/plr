...
(def num-langs   {:so "49"      :octo "10"      :rm "20"       :languish "533"       :jb "27"      :pypl "29"      :ieee "55"      :tiobe "50"})
(def freq        {:so "Annual"  :octo "Annual"  :rm "Biannual" :languish "Quarterly" :jb "Annual"  :pypl "Monthly" :ieee "Annual"  :tiobe "Monthly"})
(def last-update {:so "2024-07" :octo "2024-11" :rm "2024-06"  :languish "2025-01"   :jb "2024-12" :pypl "-"       :ieee "2024-08" :tiobe "-"})
