...
(def num-langs   {:so "42"      :octo "10"      :rm "20"       :languish "544"       :jb "28"      :pypl "29"      :ieee "52"      :tiobe "50"      :githut "50"        })
...
(def last-update {:so "2025-07" :octo "2025-11" :rm "2026-01"  :languish "2025-04"   :jb "2025-12" :pypl "-"       :ieee "2025-09" :tiobe "-"       :githut "-"         })
